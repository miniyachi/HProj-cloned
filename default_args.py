def config():
    ...
    defaults['probType'] = 'cvx_qcqp'
    defaults['probSize'] = [100, 50, 50, 10000]
    defaults['testSize'] = 833
    defaults['saveAllStats'] = False
    defaults['resultsSaveFreq'] = 1000
    defaults['seed'] = 2025

    defaults['mapping_para'] = \
        {'training': True, 'testing': False, 'n_samples': 1024, 't_samples': 10000, 'bound': [0, 1], 'scale_ratio': 1, 'shape': 'square', 'total_iteration': 10000, 'batch_size': 512, 'num_layer': 3, 'lr': 0.0001, 'lr_decay': 0.9, 'lr_decay_step': 1000, 'penalty_coefficient': 10, 'distortion_coefficient': 1, 'transport_coefficient': 0, 'testing_samples': 1024}
