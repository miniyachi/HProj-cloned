def config():
    ...
    defaults['probSize'] = [100, 100, 50, 10000]
    ...
    defaults['nn_para'] = \
        {'training': True, 'testing': True, 'approach': 'unsupervise', 'total_iteration': 20000, 'batch_size': 512, 'lr': 0.001, 'lr_decay': 0.9, 'lr_decay_step': 1000, 'num_layer': 3, 'objWeight': 0.1, 'softWeightInEqFrac': 10, 'softWeightEqFrac': 10}
